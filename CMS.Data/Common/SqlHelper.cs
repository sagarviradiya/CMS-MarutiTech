...
namespace CMS.Data
{
    public class SqlHelper
    {
        ...
        /// </param>
        /// <returns></returns>
        public SqlCommand CreateCommand(string qry, CommandType type, Dictionary<string, object> args)
        {
            var cmd = new SqlCommand(qry, _conn);
        ...
        public int ExecNonQuery(string qry, Dictionary<string, object> args)
        {
        ...
        /// <param name="args">Any number of parameter name/value pairs and/or SQLParameter arguments</param>
        /// <returns>The number of rows affected</returns>
        public int ExecNonQueryProc(string proc, Dictionary<string, object> args)
        {
        ...
        public object ExecScalar(string qry, Dictionary<string, object> args)
        {
            using (var cmd = CreateCommand(qry, CommandType.Text, args))
            {
        ...
        /// <param name="args">Any number of parameter name/value pairs and/or SQLParameter arguments</param>
        /// <returns>Value of first column and first row of the results</returns>
        public object ExecScalarProc(string qry, Dictionary<string, object> args)
        {
        ...
        public SqlDataReader ExecDataReader(string qry, Dictionary<string, object> args)
        {
            using (var cmd = CreateCommand(qry, CommandType.Text, args))
            {
        ...
        /// <param name="args">Any number of parameter name/value pairs and/or SQLParameter arguments</param>
        /// <returns>Results as a SqlDataReader</returns>
        public SqlDataReader ExecDataReaderProc(string qry, Dictionary<string, object> args)
        {
            using (var cmd = CreateCommand(qry, CommandType.StoredProcedure, args))
            {
                return cmd.ExecuteReader();
        ...
        public DataSet ExecDataSet(string qry, Dictionary<string, object> args)
        {
            using (var cmd = CreateCommand(qry, CommandType.Text, args))
            {
        ...
        /// <param name="args">Any number of parameter name/value pairs and/or SQLParameter arguments</param>
        /// <returns>Results as a DataSet</returns>
        public DataSet ExecDataSetProc(string qry, Dictionary<string, object> args)
        {
            using (var cmd = CreateCommand(qry, CommandType.StoredProcedure, args))
            {
                var adapt = new SqlDataAdapter(cmd);
